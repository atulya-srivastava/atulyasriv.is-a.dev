...
const Index = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Collaborative task manager with real-time updates, team workspaces, and intelligent priority scheduling.",
    ...
    },
    {
      title: "Portfolio CMS",
      description:
        "Headless CMS for managing portfolio content with drag-and-drop builder and API-first architecture.",
    ...
    },
    {
      ...
      description:
        "Modern chat interface with AI integration, context awareness, and multi-model support for enhanced conversations.",
    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="fixed inset-0 opacity-70 pointer-events-none">
        <div
          ...
          style={{
            background: `
              radial-gradient(circle 800px at ${mousePosition.x}px ${
              mousePosition.y
            }px, 
                hsl(200 80% 50% / 0.15), 
                transparent 50%),
          ...
          <div className="pt-24 flex flex-col md:flex-row items-center justify-center gap-8">
            <div className="relative group">
              ...
              <Avatar className="relative w-32 h-32 md:w-40 md:h-40 border-4 border-blue-500/50 shadow-2xl">
                <AvatarImage
                  src="https://i.pinimg.com/736x/b0/82/2c/b0822c17e727de4ece2e03f39e51e3ed.jpg"
                  className="object-cover"
                  alt="Atulya Srivastava"
                />
                <AvatarFallback className="bg-gradient-to-br from-blue-600 to-cyan-500 text-2xl text-white">
                  AS
                </AvatarFallback>
              </Avatar>
            </div>
            <div className="text-left">
              <h1 className="text-4xl md:text-7xl font-bold mb-2">
                ...
                <span
                  ...
                  className="bg-gradient-to-r from-blue-500 via-cyan-500 to-purple-600 bg-clip-text text-transparent inline"
                >
                  Atulya Srivastava
                </span>
                {/* runOnce={true} */}
     ...
     {/* TechStack Section */}
      ...
      <section id="projects" className="py-20 px-6 relative">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <TextScramble
            text="<projects>"
            className="text-3xl md:text-4xl font-bold mb-12 font-mono bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent flex items-center"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${project.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl`}
                />
                <div
                  className={`absolute inset-[1px] bg-gradient-to-br from-card via-card/95 to-card/90 rounded-[11px] z-10`}
                />
                ...
                <CardContent className="relative z-20 p-8 space-y-6">
                  <div className="flex items-start justify-between">
                    ...
                    <div
                      className={`p-3 rounded-xl bg-gradient-to-br ${project.gradient} opacity-80 group-hover:opacity-100 group-hover:scale-110 transition-all duration-300 flex-shrink-0 ml-4`}
                    >
          ...
          <p className="text-sm text-muted-foreground font-mono mt-12">
            &lt;/projects&gt;
          </p>
        </div>
      </section>
      ...
      <section id="timeline" className="py-20 px-6 relative">
        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          <TextScramble
            text="<timeline>"
            className="text-3xl md:text-4xl font-bold mb-12 font-mono bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent"
            isPaused={isAnimationPaused}
          >
              ...
              <div key={index} className="relative pl-20">
                ...
                <Card className="bg-card/50 backdrop-blur-sm border-blue-500/30 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-500">
                  <CardContent className="p-6">
                    <div className="font-mono text-cyan-500 text-sm mb-2 font-bold">
                      {item.year}
                    </div>
      ...
      <section id="contributions" className="py-20 px-6 relative">
        <div className="container mx-auto max-w-4xl relative z-10">
          <TextScramble
            text="<contributions>"
            className="text-3xl md:text-4xl font-bold mb-12 font-mono bg-gradient-to-r from-green-500 to-cyan-500 bg-clip-text text-transparent"
            isPaused={isAnimationPaused}
          >
              ...
              <CardContent className="p-6 flex gap-6">
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="h-32 relative border-2 border-dashed border-blue-500/30 rounded-lg flex items-center justify-center text-muted-foreground text-sm bg-blue-500/5">
                    <img
                      src="https://leetcard.jacoblin.cool/atulya-srivastava?ext=heatmap&theme=transparent&hide=ranking,total-solved-text,easy-solved-count,medium-solved-count,hard-solved-count"
                      alt="My LeetCode Heatmap"
                    />
                  </div>
                </div>
              </CardContent>
      ...
      <section id="contact" className=" py-20 px-6 relative">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          <TextScramble
            text="<contact>"
            className="text-3xl md:text-4xl font-bold mb-8 font-mono bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 bg-clip-text text-transparent"
            isPaused={isAnimationPaused}
          >
          ...
          <div className="flex flex-col items-center gap-8 mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                variant="outline"
                size="lg"
                className="group border-blue-500/50 hover:bg-blue-500/10 hover:border-blue-500"
                asChild
              >
                <a
                  href="https://github.com/atulya-srivastava"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button
                variant="outline"
                size="lg"
                className="group border-cyan-500/50 hover:bg-cyan-500/10 hover:border-cyan-500"
                asChild
              >
                <a
                  href="https://linkedin.com/in/atulyasriv"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <Button
                size="lg"
                className="group bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white border-0 shadow-lg shadow-blue-500/30"
                asChild
              >
      ...
      <button
        ...
        aria-label={
          isAnimationPaused ? "Resume animations" : "Pause animations"
        }
      >
      ...
      <footer className="py-8 px-6 border-t border-border/50">
        <div className="container mx-auto text-center">
          <p className="text-muted-foreground font-mono text-sm">
            &lt;footer&gt; © 2025 Atulya Srivastava. Built with React &
            TypeScript. &lt;/footer&gt;
          </p>
        </div>
      </footer>
